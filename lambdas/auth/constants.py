# Used to remove each respective cookie from the users browser by setting an expiration date in the past
REMOVE_NONCE_COOKIE = "NONCE=; Path=/; Expires=Sun, 01 Feb 1970 00:00:00 GMT"
REMOVE_TOKEN_COOKIE = "TOKEN=; Path=/; Expires=Sun, 01 Feb 1970 00:00:00 GMT"
...
<body>
    <div class="cover"><h1>Unauthorized<small>401</small></h1><p class="lead">There was a problem authenticating your request.</p></div>
</body>
</html>
""",
}
...
<body>
    <div class="cover"><h1>Access Denied <small>403</small></h1><p class="lead">You do not have the required permissions to view this page.</p></div>
</body>
</html>
""",
}
